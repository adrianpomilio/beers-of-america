...
var favorite_cmp_1 = require('../favorites/favorite-cmp');
var Beer = (function () {
    function Beer(http, beerSvc) {
        this.http = http;
        this.beerSvc = beerSvc;
    }
    Beer.prototype.onInit = function () {
        this.result = { data: [] };
        this.favorites = [];
    };
    ...
    Beer.prototype.saveBeer = function (event) {
        var _this = this;
        this.http.post('/favorites', JSON.stringify({
            nameDisplay: event.nameDisplay,
            description: event.description
        }))
            .toRx()
            .subscribe(function (res) {
            _this.favorites.push(res._body);
    ...
    Beer = __decorate([
        ...
        angular2_1.View({
            ...
            directives: [angular2_1.NgFor, angular2_1.NgIf, tooltip_1.Tooltip, favorite_cmp_1.FavoriteCmp]
        }), 
